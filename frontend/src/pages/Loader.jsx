...
export default function Loader() {
  ...
  useEffect(() => {
    ...
    tl
      .to(letters, { duration: 0.6, y: 0, stagger: 0.05, ease: Power2.easeOut })
      .to(
        letters,
        { css: { '--clipPath': 'inset(0% 0 0 0)' }, duration: 0.8, delay: 0.3, ease: Power1.easeInOut }
      )
      .to(letters, { duration: 0.6, y: 100, stagger: 0.05, delay: 0.5 });
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-[#111] overflow-hidden font-[emiken]">
      <div
        ref={textRef}
        className={`
          flex relative overflow-hidden
          text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[6.3rem] 2xl:text-[6.5rem]
